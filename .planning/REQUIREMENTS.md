...
- [ ] **SRC-01**: Usuario puede pegar una URL de archivo GitHub (`blob` o `raw`) y crear un bloque embebido.
- [ ] **SRC-02**: Plugin valida formato de URL y devuelve errores accionables para URLs inválidas.
- [ ] **SRC-03**: Plugin soporta al menos `.md`, `.txt`, `.json`, `.js`, `.ts`.
